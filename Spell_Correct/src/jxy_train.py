...
class CBZ_Dataset(Dataset):
    ...
    def get_data_from_jsonl(self):
        ...
        for line in lines:
            ...
            trg_sent = onedata["correction"]
            src_sent = zengqiang_tool.parser(trg_sent)
            # print(src_sent)
            # print(trg_sent)
            # print()
...
class Trainer(object):
    ...
    def train(self):
        # todo 循环 epoch
        # model_path = r"/home/hufei/pyapp/CCL2022/CCL2022-CLTC/C1_cuobiezi/cbz_models/f0_bert_base_lang8.自动增强_v0/train.lang8_原始错别字-epoch-100.pt"
        # self.model.load_state_dict(torch.load(model_path))

        # model_path = r"/home/hufei/pyapp/CCL2022/CCL2022-CLTC/C1_cuobiezi/代码提交内容/models/jxy/train.lang8_原始错别字-epoch-50.pt"
        # self.model.load_state_dict(torch.load(model_path))
...
if __name__ == "__main__":
    ...
    config = {
        ...
        'train_path': r"/home/hufei/pyapp/CCL2022/CCL2022-CLTC/C1_cuobiezi/datas/train_data/lang8.增强.v0/train.v0.jsonl",
        'dev_path': r'/home/hufei/pyapp/CCL2022/CCL2022-CLTC/C1_cuobiezi/datas/train_data/lang8.增强.v0/dev.v0.jsonl',
        'save_path': r'/home/hufei/pyapp/CCL2022/CCL2022-CLTC/C1_cuobiezi/代码提交内容/models/jxy2',
        'tag': 'train.lang8_原始错别字',
        'num_epochs': 100,
        'batch_size': 96,
        'tie_cls_weight': True,
        'word_base': r"/home/hufei/pyapp/CCL2022/CCL2022-CLTC/C1_cuobiezi/datas/增强/错别字库_v1.json"
    }
    zengqiang_tool = ZengQiang(config['word_base'])
