...
RESULT_FILE1=./samples/MuCGEC_test.hyp.m2.char
RESULT_FILE2=./samples/MuCGEC_test.hyp.m2.char
RESULT_FILE3=./samples/MuCGEC_test.hyp.m2.char

# Seq2Seq的三个模型，更换了3个随机种子
RESULT_FILE4=./samples/MuCGEC_test.hyp.m2.char
RESULT_FILE5=./samples/MuCGEC_test.hyp.m2.char
RESULT_FILE6=./samples/MuCGEC_test.hyp.m2.char
