...
## Tokenize
SRC_FILE=../../data_track2/lang8/lang8_src.txt  # 每行一个病句
TGT_FILE=../../data_track2/lang8/lang8_trg.txt   # 每行一个正确句子，和病句一一对应
...
## Generate label file
LABEL_FILE=../../data_track2/lang8/train.label  # 训练数据
...
OUTPUT_FILE=$RESULT_DIR"/cged2022_test.output"
