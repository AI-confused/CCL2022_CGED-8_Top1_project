...
from Grammar_Error_Detect.src.bert_crf_result import GrammarDetectResult
...
class GrammarDetectTask(BasePytorchTask):
    def __init__(self, task_setting: TaskSetting, load_train: bool=False, load_dev: bool=False, load_test: bool=False):
        ...
        # BIEOS标签
        self.position_id2label = {index: value for index, value in enumerate(['O', 'S-B', 'M-B', 'W-B', 'R-B', 'S-I', 'M-I', 'W-I', 'R-I', 'S-E', 'M-E', 'W-E', 'R-E', 'S-S', 'M-S', 'W-S', 'R-S'])}
        self.position_label2id = {value: index for index, value in enumerate(['O', 'S-B', 'M-B', 'W-B', 'R-B', 'S-I', 'M-I', 'W-I', 'R-I', 'S-E', 'M-E', 'W-E', 'R-E', 'S-S', 'M-S', 'W-S', 'R-S'])}
    ...
    def prepare_task_model(self):
        ...
        self.model = BertCrfForNer(model_name=self.setting.model_name, config=self.bert_config, dropout=self.setting.dropout)
